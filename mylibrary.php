    ...
    <nav class="navbar navbar-expand-sm bg-light p-1 sticky-top shadow-lg">
            <div class="container-fluid">
                ...
                <div class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <div class="nav-item search-box">
                        <input type="search" class="search-input" placeholder="Ketikkan Judul Buku...">
        ...
        <div class="content">
            <header class="px-5 pt-4">
                <table class="w-100">
                        <tr>
                            <td class="px-4"><h2>Koleksi saya</h2></td>
                            <td class="px-4 align-middle text-end"><a href="history.php" class="link-secondary link-offset-1 link-underline-opacity-0 link-underline-opacity-75-hover"><i class="bi bi-clock-history"></i>&nbsp;&nbsp;Riwayat</a></td>
                        </tr>
                    </table>
            </header>
            <div>
            ...
            <div class="w-100">
            <?php
            $sql_pinjam = "SELECT * FROM peminjaman WHERE id_user = '$id_user' AND status_pinjam = 'dipinjam'";
