...
<head>
    ...
    <title>Page Update Data Buku - Slebook</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Update Data Buku</h1>
                ...
                <form action="update_buku.php" method="post" enctype="multipart/form-data">
                    <div class="container-fluid px-4">
                        <div class="form-group">
                            <label>ID BUKU</label>
                            <input type="text" class="form-control" id="inputIDBUKU" readonly name="id_buku"
                                value="<?php echo $id; ?>">
                        </div>
                        <div class="form-group">
                            <label for="inputJudulBuku">Judul buku</label>
                            <input type="text" name="judul" class="form-control" id="inputJudulBuku"
                                value="<?php echo $row['judul']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="inputPenulis">Nama Penulis</label>
                            <input type="text" name="author" class="form-control" id="inputPenulis"
                                value="<?php echo $row['penulis']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="inputTahunTerbit">Tahun Terbit</label>
                            <input type="number" name="thn" class="form-control" id="inputTahunTerbit"
                                placeholder="Tahun Terbit" min="1900" max="2099"
                                value="<?php echo $row['tahun_terbit']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="inputPenerbit">Penerbit</label>
                            <input type="text" name="publisher" class="form-control" id="inputPenerbit"
                                value="<?php echo $row['penerbit']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="inputKategori">Kategori</label>
                            <input type="kategori" name="kategori" class="form-control" id="inputKategori"
                                value="<?php echo $row['kategori']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="inputStok">Stok Buku</label>
                            <input type="number" name="stok" class="form-control" id="inputStok"
                                value="<?php echo $row['stok']; ?>" min="1" max="99">
                        </div>
                        <div class="form-group">
                            <label for="inputDeskripsi">Deskripsi</label>
                            <textarea type="text" name="deskripsi" class="form-control" rows="5" id="inputDeskripsi"
