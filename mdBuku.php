...
<head>
  ...
  <title>Page Data Buku - Slebook</title>
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          ...
          <form action=\"./detailDataBuku.php\" method=\"post\"class=\"d-inline-block mb-2\">
          ...
          <form action=\"./updateDataBuku.php\" method=\"post\"class=\"d-inline-block mb-2\">
                <input type=\"hidden\" name=\"id\" value=\"$data[id_buku]\">
                <button type=\"submit\" name=\"submit\" class=\"btn btn-success\"><i class=\"bi bi-pencil-square\"></i></button>
          </form>
          <form action=\"./hapusDataBuku.php\" method=\"post\"class=\"d-inline-block\">
                <input type=\"hidden\" name=\"id\" value=\"$data[id_buku]\">
