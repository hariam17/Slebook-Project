...
<head>
    ...
    <title>Page Tambah Data Buku - Slebook</title>
                ...
                <form action="tambah_buku.php" method="post" enctype="multipart/form-data">
                    <div class="container-fluid px-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="kategori" name="category" class="form-control" id="inputKategori"
                                placeholder="Kategori">
                        </div>
                        <div class="form-group">
                            <label for="inputStok">Stok Buku</label>
                            <input type="number" name="stok" class="form-control" id="inputStok" placeholder="Stok Buku"
                                min="1" max="99">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="fileCover">Input Cover Buku</label> <br>
                            <input type="file" name="cover" class="form-control-file" id="fileCover">
                        </div>
                        <div class="form-group">
                            <label for="fileBuku">Input File Buku</label> <br>
